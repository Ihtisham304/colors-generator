...
from colors.views import register_user, login_user, color_hash_list_create ,color_hash_update , delete_color_hash
...
urlpatterns = [
    ...
    path('delete/<int:id>/', delete_color_hash, name='colorhash-delete'),
